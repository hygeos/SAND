...
class Geo:
    ...
    class Point(_Base):
        ...
        def __init__(self, lat: float, lon: float, extend_factor: float = 0.1):
            """
    ...
    class Polygon(_Base):
        ...
        def __init__(self, latmin: float, latmax: float, lonmin: float, lonmax: float):
            """
...
class Name:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"Name(contains={self.contains}, startswith='{self.startswith}', "
